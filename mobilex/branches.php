...
?>
	...
	<p class="profile"><img src="../images/branches/<?php echo $photo; ?>" width="50px">&nbsp;<a href="#"><?php echo $name;?></a></p>
	<p class="details" align="right"><a class="service" href="staffmembers.php"><input type="button" value="Staff calendar" class="btn-success"/></a> </p>
	</div>
  	<?php
		}
	?>
