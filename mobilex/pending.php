...
<div class="content">
  <div class="wrap">
    <div class="post">
	  <a href="bookings.php">Served</a>&nbsp;|&nbsp;<a href="canceled.php">Canceled</a>            
    </div> 
    <div class="post">
...
$cost[4]="40,000";
	...
	<p class="details"><a class="service" href="#"><?php echo $service[$count];?></a> for <?php echo $cost[$count];?>/= . To be served by <a class="staff" href="#">Namuli sarah</a></p>
