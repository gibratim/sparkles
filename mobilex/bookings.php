...
<div class="content">
  <div class="wrap">
    <div class="post">
	  <a href="pending.php">Pending</a>&nbsp;|&nbsp;<a href="canceled.php">Canceled</a>            
    </div> 
    <div class="post">
	  <h4>Cusotmers served today</h4>            
    </div>	        
    <div class="post">
	<?php
	//1
...
$cost[4]="40,000";
	...
	<p class="details"><a class="service" href="#"><?php echo $service[$count];?></a> for <?php echo $cost[$count];?>/= . Served by <a class="staff" href="#">Namuli sarah</a></p>
