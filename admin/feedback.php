...
?>
<?php
$right_name="feedback";// the right needed to access this content
...
<script type="text/javascript">
 setInterval(function(){
  $('#feedback_data_div').load('feedback_data.php');
    }, 10000);
</script>
 </head>    
<body>
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li class="active"><h4>Feedback  &nbsp;&nbsp;<a href="index.php"><input type="button" class="btn-danger" value="Back" /></a></h4></li>
	                                </ul>
                            	</div>
                        	</div>
                    	</div>
					<div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12" id="feedback_data_div">
                                    <?php include("feedback_data.php");?>
									        </div>
                            </div>
                        </div>
                        <!-- /block -->
