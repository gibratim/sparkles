...
<?php 
include("../connect.php");
$selb=mysql_query("select * from staff where branch_id='$branch_id' && staff_id='$staff_id'")or die(mysql_error());
$valb=mysql_fetch_array($selb);
 ...
 //empty column
 $empty="<td title='Has no customer'>&nbsp;Free</td>";
   $booked1='<td valign="middle" style="color:#009900;background: linear-gradient(to right, rgba(0, 255,100, 0.9) 0%, rgba(0, 255, 100, 0.4) 59%, rgba(0, 255, 100, 0.5) 100%);">&nbsp;</td>';

   $booked2='<td valign="middle" style="color:#009900;background: linear-gradient(to right, rgba(255, 0,100, 0.9) 0%, rgba(255, 0, 100, 0.4) 59%, rgba(255, 0, 100, 0.5) 100%);">&nbsp;</td>';
...
$sel=mysql_query("select * from booking where staff_id='$staff_id' && booked_time >= '15:30' && booked_time < '16:00' && booked_date='$date' && status !='canceled' ")or die(mysql_error());
 ...
 <tr>
 <th colspan="2" align="center">4:00PM-5:00PM</th>
...
<script type="text/javascript">
 setTimeout(function(){
  $('#schedule-content-div').load('staff_work_calendar_data.php');
    }, 5000);
</script>
<?php
}
