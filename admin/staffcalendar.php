...
if(isset($_REQUEST['cmd'])){
  ...
  $_SESSION['staff_id'] = $json->{"staff_id"};
  $_SESSION['staff_name'] = $json->{"staff_name"};
  $_SESSION['staff_photo']= $json->{"staff_photo"};
   header('Location:staffcalendar.php');
}elseif(!isset($_SESSION['staff_id'],$_SESSION['staff_name'], $_SESSION['staff_photo'])){
  echo "<h1 style='color:red'>ACCESS  DENIED</h1>";
  return;
}else{
  $staff_id = $_SESSION['staff_id'];
  $staff = $_SESSION['staff_name'];
  $staff_photo = $_SESSION['staff_photo'];
}
?>
...
function datePicker(date){
   document.getElementById('loading').innerHTML='<img src="../images/load.gif" alt="loading..." />';
    $('#booking_content_div').load('staffcalendar_data.php?date='+date);   
   setTimeout(function(){
...
<?php include("top_bar.php"); ?>
 <div class="container-fluid">
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
									 ...
									 <p style="vertical-align:middle; font:Arial, Helvetica, sans-serif; font-size:large; font-weight:bold;color:#990000;">
									 <img src="../images/staff/<?php echo $staff_photo;?>" width="50px"/>&nbsp;&nbsp;<?php echo $staff;?> <input type="button" id="pickdate-1" value="<?php 
   ...
   echo $date;
   } ?>" class="btn-success" style="width:300px; font-size:large"/>&nbsp;&nbsp;<?php echo $_SESSION['branch_name'];?>
					...
					<?php include("staffcalendar_data.php"); ?>
				    </div>
				</div>
