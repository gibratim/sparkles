...
?>
<?php
$right_name="staff_calendar";// the right needed to access this content
                            	...
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <i class="icon-chevron-right show-sidebar" style="display:none;"><a href='#' title="Show Sidebar" rel='tooltip'>&nbsp;</a></i>
	                                      <li class="active"><h3>Staff calendar</h3></li>
	                                </ul>
                            	</div>
                        	</div>
                    	</div>
                                    ...
                                    <table width="100%">                                        
                                        <tbody>
                                            <tr>
												...
												<a style="text-decoration:none" href="staffmembers.php?cmd=<?php
												$data = '{"branch_id":"'.$branch_id.'","branch_name":"'.$name.'","branch_photo":"'.$photo.'"}';
												
												$encrypted = $encryption->encode($data);
												echo $encrypted;
												?>"><input type="button" value="Staff members" class="btn-success"/></a>&nbsp;&nbsp;<a style="text-decoration:none" href="work_calendar.php?cmd=<?php
												$data = '{"branch_id":"'.$branch_id.'","branch_name":"'.$name.'","branch_photo":"'.$photo.'"}';
												
												$encrypted = $encryption->encode($data);
												echo $encrypted;
												?>"><input type="button" value="Calendar" class="btn-success"/></a>
												</td>
                                                </tr>
                                        </tbody>
                                    </table>
