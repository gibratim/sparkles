      ...
      <div class="left_nav_slidebar">
        <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> SERVICES <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul>
              <li> <a href="departments.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>View services</b> </a> </li>
      ...
      <div class="container clear_both padding_fix">
          ...
          <div class="col-sm-3 col-sm-6">
            <div class="information blue_info">
              ...
              <div class="info blue_symbols"><i class="fa fa-shopping-cart icon"></i></div>
                ...
                <b class=""><small>Better than yesterday ( 8.5% )</small></b>
          ...
          <div class="col-sm-3 col-sm-6">
            <div class="information red_info">
              ...
              <div class="info red_symbols"><i class="fa fa-comments icon"></i></div>
                ...
                <b class=""><small>Better than yesterday ( 9.5% )</small></b>
          ...
          <div class="col-sm-3 col-sm-6">
           <div class="information gray_info">
              ...
              <div class="info gray_symbols"><i class="fa fa-money icon"></i></div>
                <span>TODAY'S UNIQUE VISITS </span>
                <h1 class="bolded">12,254</h1>
                <div class="infoprogress_gray">
                  <div class="grayprogress"></div>
                </div>
                <b class=""><small>Better than yesterday ( 11.5% )</small></b>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="block-web">
              <div class="header">
                <h3 class="content-header">Bookings</h3>
              </div>
             		<div>
<table width="100%" cellpadding="10px">
  <tr>
    <th style="border-bottom:1px solid #CCCCCC;" scope="col">&nbsp;</th>
    <th style="border-bottom:1px solid #CCCCCC;" scope="col">&nbsp;</th>
    <th style="border-bottom:1px solid #CCCCCC;"  scope="col">Booked</th>
    <th style="border-bottom:1px solid #CCCCCC;" scope="col">&nbsp;</th>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
    <td style="border-bottom:1px solid #CCCCCC;" >&nbsp;Joan Kalule</td>
    <td style="border-bottom:1px solid #CCCCCC;color:#009900;" >02/09/2015</td>
    <td style="border-bottom:1px solid #CCCCCC; color:red;" >Just now</td>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
    <td style="border-bottom:1px solid #CCCCCC;" >&nbsp;Suzan Kayemba</td>
    <td style="border-bottom:1px solid #CCCCCC;color:#009900;">06/09/2015</td>
    <td style="border-bottom:1px solid #CCCCCC; color:red;">Just now</td>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
    <td style="border-bottom:1px solid #CCCCCC;" >&nbsp;Pualinah M</td>
    <td style="border-bottom:1px solid #CCCCCC;color:#009900;">07/09/2015</td>
    <td style="border-bottom:1px solid #CCCCCC; color:red;">1 minute a go</td>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
    <td style="border-bottom:1px solid #CCCCCC;" >&nbsp;Pualine Deby</td>
    <td style="border-bottom:1px solid #CCCCCC;color:#009900;">02/09/2015</td>
    <td style="border-bottom:1px solid #CCCCCC; color:red;">1 minute a go</td>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
    <td style="border-bottom:1px solid #CCCCCC;" >&nbsp;Joan N</td>
    <td style="border-bottom:1px solid #CCCCCC;color:#009900;">03/09/2015</td>
    <td style="border-bottom:1px solid #CCCCCC; color:red;">3 minute a go</td>
  </tr>
  <tr>
    <td colspan="4"><input class="btn-success" style="margin-top:10px" type="button" value="More.."/></td>
 ...
 <div class="porlets-content">
  ...
  <tr>
    <td><h4>Bookings:</h4></td>
    <td><h4>2897</h4></td>
  </tr>
 <tr>
    <td><h4>Canceled bookings:</h4></td>
    <td><h4>281</h4></td>
  </tr>
  <tr>
    <td><h4>Approved bookings:</h4></td>
    <td><h4>2585</h4></td>
  </tr>
  <tr>
    <td><h4>Total sales:</h4></td>
    <td><h4>2,585,000/=</h4></td>
  </tr>
</table>
        ...
        <div class="row">          
          ...
          <div class="col-md-4 ">
            <div class="block-web">
              <h3 class="content-header">My Notes</h3>
              <div class="block widget-notes">
                <div contenteditable="true" class="paper"> Send email to supplier<br>
                  Conference at 4 pm.<br>
                  Order shampoo<br>
                  Meet client at 7 am<br>
                  </div>
              </div>
              <!--/widget-notes-->
            </div>
          ...
          <div class="col-md-4 ">
            ...
            <div class="list-group"> <a class="list-group-item" href="#"> <span class="badge bg-danger">254</span> Bookings </a> <a class="list-group-item" href="#"> <span class="badge bg-success">1,760,000/=</span> Sales </a> </div>
            <!--/calendar end-->
          </div>
          <!--/col-md-4 end-->
        </div>
