            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="#"><i class="glyphicon glyphicon-eye-open"></i><span> Services</span></a>
                        </li>
                        <li><a class="ajax-link" href="#"><i
                                    class="glyphicon glyphicon-edit"></i><span> Branches</span></a></li>
                        <li><a class="ajax-link" href="#"><i class="glyphicon glyphicon-list-alt"></i><span> Customers</span></a>
                        </li>
                        <li class="nav-header hidden-md">Action</li>
                        <li><a class="ajax-link" href="#"><i
                                    class="glyphicon glyphicon-align-justify"></i><span> Report</span></a></li>
                        <!--<li class="accordion">
                        ...
                        <li><a class="ajax-link" href="#"><i class="glyphicon glyphicon-calendar"></i><span> Tips</span></a>
                        </li>
                        <li><a class="ajax-link" href="grid.html"><i
                                    class="glyphicon glyphicon-th"></i><span> Offers</span></a></li>
                        <li><a href="tour.html"><i class="glyphicon glyphicon-globe"></i><span> Tour</span></a></li>
                        <li><a class="ajax-link" href="icon.html"><i
                                    class="glyphicon glyphicon-star"></i><span> Transactions</span></a></li>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Bookings</h2>
  ...
  <tr>
    ...
    <td style="border-bottom:1px solid #CCCCCC; color:red;border-right:1px solid #CCCCCC;" >Just now</td>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
  ...
  <tr>
    ...
    <td style="border-bottom:1px solid #CCCCCC; color:red;border-right:1px solid #CCCCCC;">1 minute a go</td>
  </tr>
  <tr>
    <td style="border-bottom:1px solid #CCCCCC;border-left:1px solid #CCCCCC" align="right"><img src="../images/ccz.png" width="50px" /></td>
  ...
  <tr>
    ...
    <td style="border-bottom:1px solid #CCCCCC; color:red;border-right:1px solid #CCCCCC;">3 minute a go</td>
  </tr>
  <tr>
