    ...
    <body onLoad="resize_fn()" onResize="resize_fn();">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li class="active"><h4>New bookings</h4></li>
	                                </ul>
                            	</div>
                        	</div>
                    	</div>
					<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">New bookings</div>
                            </div>
				...
				<p class="details">Booked for <a class="service" href="#">Cut & file for men both hands and feet</a>  at 15,000/= on 12/09/2015 1:00PM. To be served by <a class="staff" href="#">Namuli sarah</a></p>									<p style="color:red">just now</p>
									</div>
  									<?php
									}
									?>
