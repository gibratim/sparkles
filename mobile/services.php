                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li class="active"><h6>Our services</h6></li>
	                                </ul>
                            	</div>
                        	</div>
                    	</div>
					<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Our services</div>
                            </div>
                            <div class="block-content collapse in">
								...
								?>
									...
									<p class="profile"><img src="../images/services/default.png" width="40px">&nbsp;<a href="#">Cut & file for men both hands and feet</a></p>
				<p class="details">Duration: 20 min <br/>Cost: 36,000/=</p>									
				<p align="right"><input type="button" value="Edit" class="btn-success" /></p>
									</div>
  									<?php
									}
									?>
									<style type="text/css">
									.booking .profile a{ color:#000099;	 font-size:small; font-weight:bold;	}
