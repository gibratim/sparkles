                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li class="active"><h6>Reports</h3></li>
	                                </ul>
                            	</div>
                        	</div>
                    	</div>
					<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								...
								?>						
								</select>&nbsp;<input type="text" name="year" placeholder="Year"/>&nbsp;
								<a href="#"><input type="button" class="btn-success" value="Check for report" /></a>
								</div>
                            </div>
