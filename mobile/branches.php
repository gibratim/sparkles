...
<script type="text/javascript">
		  function resize_fn(){
		   ...
		   if(width>=700){
		      window.location.href = "../admin/branches.php";
		   }
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active">
                            <a href="#" title="Staff members"><i class="icon-chevron-right"></i> Branches</a>
                        </li>                        
                        <li>
                            ...
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <table width="100%">                                        
                                        <tbody>
                                            <tr>
                                                <td width="40%"><img src="../images/branches/<?php echo $photo; ?>" style="border:1px solid #CCCCCC; border-radius:10px" /></td>
                                                <td width="60%" align="center"><?php echo $address; ?><br/>
												<a href="staffmembers.php"><input type="button" value="Staff members" class="btn-success"/></a>
												</td>
                                                </tr>
                                        </tbody>
                                    </table>
