...
<script type="text/javascript">
		  function resize_fn(){
		   ...
		   if(width>=700){
		      window.location.href = "../admin/tips.php";
		   }
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active">
                            <a href="#" title="Beauty tips"><i class="icon-chevron-right"></i> Tips</a>
                        </li>
					...
					<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Tips</div>
                            </div>
